...
public enum KnownBehaviour {
	...
	KnownBehaviour(String jpnId, String engId) {
		this(jpnId, engId, false, false);
	}
	
	KnownBehaviour(String jpnId, String engId, boolean isJump) {
		this(jpnId, engId, isJump, false);
	}

	KnownBehaviour(String jpnId, String engId, boolean isJump, boolean isIeThrow) {
		this.jpnId = jpnId;
		this.engId = engId;
		this.isJump = isJump;
	...
	public static KnownBehaviour parseString(String name, XmlLanguages language) {
		for(KnownBehaviour behaviour: KnownBehaviour.values()) {
