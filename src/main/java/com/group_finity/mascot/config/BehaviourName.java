...
public enum BehaviourName {
	...
	JumpFromLeftWall("左の壁に飛びつく", "JumpFromLeftWall"),
	JumpFromRightWall("右の壁に飛びつく", "JumpFromRightWall"),
	...
	JumpFromBottomOfIE("IEの下に飛びつく", "JumpFromBottomOfIE"),
	
	JumpOnIELeftWall("IEの左に飛びつく", "JumpOnIELeftWall"),
	JumpOnIERightWall("IEの右に飛びつく", "JumpOnIERightWall"),
	ThrowIEFromLeft("IEを右に投げる", "ThrowIEFromLeft"),
	ThrowIEFromRight("IEを左に投げる", "ThrowIEFromRight"),
	
	WalkAndThrowIEFromRight("走ってIEを右に投げる", "WalkAndThrowIEFromRight"),
	WalkAndThrowIEFromLeft("走ってIEを左に投げる", "WalkAndThrowIEFromLeft")
	;
